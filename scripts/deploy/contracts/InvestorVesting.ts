...
const vestingSeed = [
  {
    ...
    vestingAmount: ethers.utils.parseEther("750000000"),
    duration: 63072000,
    claimedAmount: 0,
    lastClaimedTime: 0,
    initialAmount: ethers.utils.parseEther("300000000"),
    initialClaimed: false,
    claimStartTime: startDate + 0
  },
  {
    beneficiary: "0xb5408c2977daa3E371279b72bD598000db84d12a",
    vestingAmount: ethers.utils.parseEther("1115000000"),
    duration: 63072000,
    claimedAmount: 0,
    lastClaimedTime: 0,
  ...
  },
  {
    ...
    vestingAmount: ethers.utils.parseEther("500000000"),
    duration: 63072000,
    claimedAmount: 0,
    lastClaimedTime: 0,
    initialAmount: ethers.utils.parseEther("50000000"),
    initialClaimed: false,
    claimStartTime: startDate + 0
  },
  {
  ...
  },
  {
    ...
    vestingAmount: ethers.utils.parseEther("3000000000"),
    duration: 157680000,
    claimedAmount: 0,
    lastClaimedTime: 0,
    initialAmount: ethers.utils.parseEther("0"),
  ...
  },
  {
    ...
    vestingAmount: ethers.utils.parseEther("2000000000"),
    duration: 157680000,
    claimedAmount: 0,
    lastClaimedTime: 0,
    initialAmount: ethers.utils.parseEther("0"),
  ...
  },
  {
    ...
    vestingAmount: ethers.utils.parseEther("350000000"),
    duration: 63072000,
    claimedAmount: 0,
    lastClaimedTime: 0,
    initialAmount: ethers.utils.parseEther("0"),
  ...
  },
  {
    ...
    vestingAmount: ethers.utils.parseEther("50000000"),
    duration: 31536000,
    claimedAmount: 0,
    lastClaimedTime: 0,
    initialAmount: ethers.utils.parseEther("5000000"),
    initialClaimed: false,
    claimStartTime: startDate + 0
  },
  {
    beneficiary: "0x73C2006262Ab12962120BEC17d1815A0EB845e76",
    vestingAmount: ethers.utils.parseEther("250000000"),
    duration: 31536000,
    claimedAmount: 0,
    lastClaimedTime: 0,
    initialAmount: ethers.utils.parseEther("25000000"),
    initialClaimed: false,
    claimStartTime: startDate + 0
  },
  {
  ...
  },
  {
    ...
    vestingAmount: ethers.utils.parseEther("60000000"),
    duration: 31536000,
    claimedAmount: 0,
    lastClaimedTime: 0,
    initialAmount: ethers.utils.parseEther("0"),
  ...
  },
  {
    ...
    vestingAmount: ethers.utils.parseEther("625000000"),
    duration: 31536000,
    claimedAmount: 0,
    lastClaimedTime: 0,
    initialAmount: ethers.utils.parseEther("62500000"),
    initialClaimed: false,
    claimStartTime: startDate + 0
  }
];
